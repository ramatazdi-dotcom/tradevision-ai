              ...
              <div className="space-y-4 w-full">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-slate-900 p-4 rounded-xl border border-slate-700">
                    ...
                    <p className="text-sm text-slate-400">Khusus saham Indonesia. Aktifkan toggle hingga hijau. Anda perlu upload <strong>Screenshot Chart di tradingview</strong> dan <strong>Screenshot Broker Summary di Aplikasi Broker Anda</strong>.</p>
                  </div>
                </div>
              </div>
            </section>
