...
// ==========================================
// BAGIAN 1: PANDUAN PENGGUNA (Revised)
// ==========================================
const UserGuide = ({ onBack }) => {
  return (
    <div className="min-h-screen bg-slate-900 text-slate-100 font-sans selection:bg-blue-500 selection:text-white p-6 md:p-12">
      <div className="max-w-4xl mx-auto">
        <button onClick={onBack} className="mb-8 flex items-center gap-2 text-slate-400 hover:text-white transition-colors group px-4 py-2 hover:bg-slate-800 rounded-lg">
          <ChevronLeft size={20} className="group-hover:-translate-x-1 transition-transform" /> Kembali ke Menu Utama
        </button>
        
        <div className="space-y-8">
          <div className="border-b border-slate-800 pb-6">
            <h1 className="text-4xl font-bold text-white mb-2">Panduan Pengguna</h1>
            <p className="text-slate-400 text-lg">Cara memaksimalkan potensi TradeVision AI untuk trading Anda.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-slate-800/50 p-6 rounded-2xl border border-slate-700/50">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-bold text-white">Setup Awal</h2>
              </div>
              <ul className="space-y-3 text-slate-300 text-sm leading-relaxed list-disc pl-5">
                <li>Klik tombol <strong>Set API Key</strong> di pojok kanan atas.</li>
                <li>Masukkan Google Gemini API Key Anda.</li>
                <li>Atau gunakan <strong>Mode Demo</strong> untuk simulasi tanpa API Key.</li>
              </ul>
            </div>
            ...
            <div className="bg-slate-800/50 p-6 rounded-2xl border border-slate-700/50">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-bold text-white">Pilih Mode</h2>
              </div>
              <div className="space-y-3 text-slate-300 text-sm leading-relaxed">
                <p><strong className="text-blue-400">Mode Teknikal:</strong> Untuk Forex/Crypto/US Stocks. Cukup upload chart.</p>
                <p><strong className="text-emerald-400">Mode Bandarmology:</strong> Khusus Saham Indo (IDX). Aktifkan toggle, lalu upload Chart & Broker Summary.</p>
              </div>
            </div>
            ...
            <div className="bg-slate-800/50 p-6 rounded-2xl border border-slate-700/50">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-bold text-white">Proses Analisa</h2>
              </div>
              <ul className="space-y-3 text-slate-300 text-sm leading-relaxed list-disc pl-5">
                <li>Pilih indikator tambahan (SMC, EMA, Engulfing) sesuai kebutuhan.</li>
                <li>Pastikan gambar jelas dan menampilkan harga di sumbu kanan.</li>
                <li>Klik <strong>Mulai Analisa</strong> dan tunggu hasil.</li>
              </ul>
            </div>

            <div className="bg-slate-800/50 p-6 rounded-2xl border border-slate-700/50">
              <div className="flex items-center gap-3 mb-4">
                <span className="w-8 h-8 rounded-full bg-orange-500 flex items-center justify-center text-white font-bold text-sm">4</span>
                <h2 className="text-xl font-bold text-white">Hasil (Trading Plan)</h2>
              </div>
              <div className="grid grid-cols-3 gap-2 mt-2 text-center">
                <div className="bg-slate-900 p-2 rounded border border-slate-700">
                  <div className="text-blue-400 text-xs font-bold">ENTRY</div>
                  <div className="text-[10px] text-slate-500">Titik Masuk</div>
                </div>
                <div className="bg-slate-900 p-2 rounded border border-slate-700">
                  <div className="text-rose-400 text-xs font-bold">SL</div>
                  <div className="text-[10px] text-slate-500">Batas Rugi</div>
                </div>
                <div className="bg-slate-900 p-2 rounded border border-slate-700">
                  <div className="text-emerald-400 text-xs font-bold">TP</div>
                  <div className="text-[10px] text-slate-500">Target Profit</div>
                </div>
              </div>
            </div>
          </div>

          <div className="bg-blue-900/20 border border-blue-500/20 p-6 rounded-2xl text-center">
            <p className="text-blue-300 text-sm font-medium">Siap untuk trading yang lebih cerdas?</p>
            <button onClick={onBack} className="mt-4 bg-blue-600 hover:bg-blue-500 text-white px-6 py-2 rounded-lg font-bold transition-colors">
              Mulai Sekarang
            </button>
          </div>
        </div>
